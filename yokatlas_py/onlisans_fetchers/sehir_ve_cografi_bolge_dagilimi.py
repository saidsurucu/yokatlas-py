...
from ..fetchers.sehir_ve_cografi_bolge_dagilimi import SehirVeCografiBolgeDagilimiOnlisansFetcher
...
async def fetch_sehir_ve_cografi_bolge_dagilimi(
    ...
    """
    fetcher = SehirVeCografiBolgeDagilimiOnlisansFetcher(program_id, year)
