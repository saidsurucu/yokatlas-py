...
async def fetch_sehir_ve_cografi_bolge_dagilimi(
    ...
    url_suffix = (
        f"/{year}/content/onlisans-dynamic/3020ab.php?y={program_id}"
        if year != 2024
        else f"/content/onlisans-dynamic/3020ab.php?y={program_id}"
    )
...
def parse_html_to_json(html_content: str) -> dict[str, Any]:
    ...
    result = {"sehir_dagilimi": [], "cografi_bolge_dagilimi": []}
