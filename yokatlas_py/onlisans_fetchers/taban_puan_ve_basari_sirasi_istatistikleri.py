...
async def fetch_taban_puan_ve_basari_sirasi_istatistikleri(program_id: str, year: int) -> dict[str, Any]:
    """
    ...
    url_suffix = f"/{year}/content/onlisans-dynamic/3000_3.php?y={program_id}" if year != 2024 else f"/content/onlisans-dynamic/3000_3.php?y={program_id}"
