...
from ..fetchers.taban_puan_ve_basari_sirasi_istatistikleri import TabanPuanVeBasariSirasiIstatistikleriOnlisansFetcher
...
async def fetch_taban_puan_ve_basari_sirasi_istatistikleri(
    ...
    """
    fetcher = TabanPuanVeBasariSirasiIstatistikleriOnlisansFetcher(program_id, year)
