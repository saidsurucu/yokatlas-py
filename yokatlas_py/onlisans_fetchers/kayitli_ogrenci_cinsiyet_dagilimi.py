...
async def fetch_kayitli_ogrenci_cinsiyet_dagilimi(
    ...
    url_suffix = (
        f"/{year}/content/onlisans-dynamic/2010.php?y={program_id}"
        if year != 2024
        else f"/content/onlisans-dynamic/2010.php?y={program_id}"
    )
    ...
    result = {"cinsiyet_dagilimi": [], "toplam": {}}
    ...
    for row in rows[1:]:  # Skip the header row
        ...
        if len(cols) == 3:
            ...
            if cinsiyet.lower() == "toplam":
                ...
                result["cinsiyet_dagilimi"].append(
                    {"cinsiyet": cinsiyet, "sayi": sayi, "oran": oran}
                )
