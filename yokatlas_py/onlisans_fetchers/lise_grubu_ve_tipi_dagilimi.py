...
async def fetch_lise_grubu_ve_tipi_dagilimi(
    ...
    url_suffix = (
        f"/{year}/content/onlisans-dynamic/3050a.php?y={program_id}"
        if year != 2024
        else f"/content/onlisans-dynamic/3050a.php?y={program_id}"
    )
    ...
    result = {"genel_liseler_grubu": [], "meslek_lisesi_grubu": []}
