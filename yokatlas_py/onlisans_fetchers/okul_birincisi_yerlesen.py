...
async def fetch_okul_birincisi_yerlesen(program_id: str, year: int) -> dict[str, Any]:
    ...
    url_suffix = (
        f"/{year}/content/onlisans-dynamic/3030c.php?y={program_id}"
        if year != 2024
        else f"/content/onlisans-dynamic/3030c.php?y={program_id}"
    )
    ...
    return {"yerlesen_sayilari": yerlesen_sayilari}
