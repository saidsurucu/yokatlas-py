...
async def fetch_ogrenim_durumu(program_id: str, year: int) -> dict[str, Any]:
    ...
    url_suffix = (
        f"/{year}/content/onlisans-dynamic/3030a.php?y={program_id}"
        if year != 2024
        else f"/content/onlisans-dynamic/3030a.php?y={program_id}"
    )
    ...
    return {"ogrenim_durumu": result, "toplam": toplam}
