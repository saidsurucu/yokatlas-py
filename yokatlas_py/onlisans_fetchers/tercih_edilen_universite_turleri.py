...
async def fetch_tercih_edilen_universite_turleri(program_id: str, year: int) -> dict[str, Any]:
    """
    ...
    url_suffix = f"/{year}/content/onlisans-dynamic/3310b.php?y={program_id}" if year != 2024 else f"/content/onlisans-dynamic/3310b.php?y={program_id}"
