...
from ..fetchers.lise_bazinda_yerlesen_dagilimi import LiseBazindaYerlesenDagilimiLisansFetcher
...
async def fetch_lise_bazinda_yerlesen_dagilimi(
    ...
    """
    fetcher = LiseBazindaYerlesenDagilimiLisansFetcher(program_id, year)
