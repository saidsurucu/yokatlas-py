...
from ..fetchers.tercih_edilen_program_turleri import TercihEdilenProgramTurleriLisansFetcher
...
async def fetch_tercih_edilen_program_turleri(
    ...
    """
    fetcher = TercihEdilenProgramTurleriLisansFetcher(program_id, year)
