...
async def fetch_tercih_edilen_universiteler(program_id: str, year: int) -> dict[str, Any]:
    """
    ...
    url_suffix = f"/{year}/content/lisans-dynamic/1320.php?y={program_id}" if year != 2024 else f"/content/lisans-dynamic/1320.php?y={program_id}"
